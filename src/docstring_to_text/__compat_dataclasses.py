...
"""
__all__ = (
	'_dataclass', '_field', '_dataclass_as_dict', '_dataclass_slots_args', '_dataclass_slots_and_kw_only_args',
)

from dataclasses import dataclass as _dataclass, field as _field, asdict as _dataclass_as_dict
