...
"""
A module with the lowest-level classes used internally.
They only depend on built-in types (and not on other custom classes in the package),
and are included by other submodules.
"""
